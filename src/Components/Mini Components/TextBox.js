export default function TextBox({ textBoxHeader, children }) {
  return (
    <div className="text-box max-w-6xl flex flex-col	m-auto desktop:max-w-full desktop:text-left desktop:mx-auto desktop:my-2 desktop:items-end desktop:w-10/12 desktop:">
